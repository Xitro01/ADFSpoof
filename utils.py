...
def print_intro():
    ...
    print(r'    ___    ____  ___________                   ____')
    print(r'   /   |  / __ \/ ____/ ___/____  ____  ____  / __/')
    print(r'  / /| | / / / / /_   \__ \/ __ \/ __ \/ __ \/ /_  ')
    print(r' / ___ |/ /_/ / __/  ___/ / /_/ / /_/ / /_/ / __/  ')
    print(r'/_/  |_/_____/_/    /____/ .___/\____/\____/_/     ')
    print(r'                        /_/                        ' + '\n')
